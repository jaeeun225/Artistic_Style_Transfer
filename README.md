...
2. **작품 만들기 페이지 (MyArtistPage)**
   ...
   **화가가 그릴 이미지 가져오기** 버튼을 통해 그리고 싶은 이미지를 가져와주세요.  
...
4. **갤러리 페이지 (GalleryPage)**
   ...
   갤러리 페이지에는 소장한 작품이 비트맵 아이콘으로 나타납니다. **감상을 원하는 작품의 비트맵 아이콘**을 선택하면 전시된 작품을 감상할 수 있습니다.

5. **작품 전시 페이지 (ArtworkPage)**

   <img src="run_example/artwork.JPG" alt="작품 전시 페이지" width="250">

   전시된 작품을 감상할 수 있습니다. 액자의 하단에는 작품의 상세 정보인 작품명, 아티스트명, 제작연도가 표시됩니다. 같은 작품명을 가진 연작들은 연작 정보 또한 표시됩니다.
